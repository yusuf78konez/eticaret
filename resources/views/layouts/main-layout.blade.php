...
<head>
    ...
    @php($path=asset('main')."/") 
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="{{$path}}main/images/icons/favicon.png"/>
<!--===============================================================================================-->
...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{$path}}fonts/linearicons-v1.0.0/icon-font.min.css">
<!--===============================================================================================-->
...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{$path}}vendor/MagnificPopup/magnific-popup.css">
<!--===============================================================================================-->
...
<body class="animsition">
    ...
    @include('layouts.main-inc.header',['path'=>$path])


	@include('layouts.main-inc.cart',['path'=>$path])


    @include('layouts.main-inc.slider',['path'=>$path])


    @include('layouts.main-inc.banner',['path'=>$path])


    @include('layouts.main-inc.product',['path'=>$path])


    @include('layouts.main-inc.footer',['path'=>$path])
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="{{$path}}images/icons/icon-close.png" alt="CLOSE">
				</button>
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="{{$path}}images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="{{$path}}images/product-detail-01.jpg" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="{{$path}}images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="{{$path}}images/product-detail-02.jpg" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="{{$path}}images/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="{{$path}}images/product-detail-03.jpg" alt="IMG-PRODUCT">
